...
//        _contentView = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, textLabel.frame.size.width, textLabel.frame.size.height)];
        _contentView = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, [UIApplication sharedApplication].keyWindow.frame.size.width, textLabel.frame.size.height)];
        textLabel.center = _contentView.center;
...
+ (void)showCenterWithText:(NSString *)text{
    [OLiToast showCenterWithText:text duration:ToastDispalyDuration];
}

+ (void)showCenterWithText:(NSString *)text duration:(CGFloat)duration{
    OLiToast *toast = [[OLiToast alloc] initWithText:text];
...
+ (void)showTopWithText:(NSString *)text{
    ...
    [OLiToast showTopWithText:text  topOffset:ToastSpace duration:ToastDispalyDuration];
}
+ (void)showTopWithText:(NSString *)text duration:(CGFloat)duration
{
    [OLiToast showTopWithText:text  topOffset:ToastSpace duration:duration];
}
+ (void)showTopWithText:(NSString *)text topOffset:(CGFloat)topOffset{
    [OLiToast showTopWithText:text  topOffset:topOffset duration:ToastDispalyDuration];
}
...
+ (void)showBottomWithText:(NSString *)text{
    ...
    [OLiToast showBottomWithText:text  bottomOffset:ToastSpace duration:ToastDispalyDuration];
}
+ (void)showBottomWithText:(NSString *)text duration:(CGFloat)duration
{
    [OLiToast showBottomWithText:text  bottomOffset:ToastSpace duration:duration];
}
+ (void)showBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset{
    [OLiToast showBottomWithText:text  bottomOffset:bottomOffset duration:ToastDispalyDuration];
}
...
+ (void)showBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset duration:(CGFloat)duration backgroundColor:(UIColor*)color {
    ...
    [toast setDuration:duration];
    [toast showFromBottomOffset:bottomOffset];
    [toast setToastBackgroundColor:color];
}
