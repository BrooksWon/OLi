 ...
 *  @return 当前请求的operation
 */
-(AFHTTPRequestOperation*)OLi_Request_GET:(NSString*)url_
 ...
 *  @return 当前请求的operation
 */
-(AFHTTPRequestOperation*)OLi_Request_POST:(NSString*)url_
                                parameters:(NSDictionary*)parameters_
                                   success:(void (^)(AFHTTPRequestOperation *operation, id responseObject))success
                                   failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure
                             cacheResponse:(BOOL)cacheResponse
 ...
 *  @return 当前请求的operation
 */
-(AFHTTPRequestOperation*)OLi_Request_PUT:(NSString*)url_
                               parameters:(NSDictionary*)parameters_
                                  success:(void (^)(AFHTTPRequestOperation *operation, id responseObject))success
                                  failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure
                            cacheResponse:(BOOL)cacheResponse
 ...
 *  @return 当前请求的operation
 */
-(AFHTTPRequestOperation*)OLi_Request_DELETE:(NSString*)url_
                                  parameters:(NSDictionary*)parameters_
                                     success:(void (^)(AFHTTPRequestOperation *operation, id responseObject))success
                                     failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure
                               cacheResponse:(BOOL)cacheResponse
